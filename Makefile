bench:
	...
	out/linux-release/src/kwinto bench test/portfolio.csv -v --cpu32 --cpu64 --gpu32 --gpu64 -n 4 -b 32768 | tee log/`hostname`_512_32768.log
	...
	out/linux-release/src/kwinto bench test/portfolio.csv -v --cpu32 --cpu64 --gpu32 --gpu64 -n 4 -b 32768 | tee log/`hostname`_1024_32768.log
